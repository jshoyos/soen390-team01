...
{
    public partial class soen390team01devdbContext : DbContext
    {
        public soen390team01devdbContext()
        {
        }

        public soen390team01devdbContext(DbContextOptions<soen390team01devdbContext> options)
            : base(options)
        {
        }
